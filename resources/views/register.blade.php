...
vh-100"
        ...
        <div class="card w-25" style="background-color: #D6E8DB; box-shadow: 1px
3px rgba(0,0,0,0.5)">
            ...
            <div class="card-body">
                <form action="/simpan" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_hp" id="nohp" class="form-control"placeholder="Masukan No Hp" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group d-flex justify-content-center">
                        <a class="btn btn-primary w-50" href="/login">Sudah
                            Punya Akun</a>
                    </div>
                </form>
            </div>
